/* 문제1. 매니저가 있는 직원은 몇 명입니까? */
select  count(manager_id)
from    employees;

/*문제2. 직원중에 최고임금(salary)과  최저임금을 
...
/*문제3. 마지막으로 신입사원이 들어온 날은 언제 입니까? 
다음 형식으로 출력해주세요. 예) 2014년 07월 10일*/
select  to_char(max(hire_date),'yyyy"년"mm"월"dd"일"')
from    employees;

/*문제4. 부서별로 평균임금, 최고임금, 최저임금을 
...
/*문제5. 업무(job_id)별로 평균임금, 최고임금, 최저임금을 
...
/*문제6. 가장 오래 근속한 직원의 입사일은 언제인가요? 
다음 형식으로 출력해주세요. 예) 2001-01-13 토요일*/
select  to_char(min(hire_date),'yyyy-mm-dd day')
from    employees;

/*문제7. 평균임금과 최저임금의 차이가 2000 미만인 
...
/*문제9. 2005년 이후 입사자중 관리자별로 평균급여 최소급여 최대급여를 알아보려고 한다.
